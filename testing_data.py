...
#
# freqs = ['hourly', 'daily', 'monthly', 'runperiod']
#
# for i in freqs:
#     for j in freqs:
#         try:
#             print(f'SOURCE FREQUENCY: {i} / OUTPUT FREQUENCY: {j}')
#             x = Table(
...
#                 energy_units_in_kwh=True,
#                 drop_nan=True,
#                 name_export_rows_not_corr_agg='testing',
#                 name_export_rows_with_NaN='testing'
#             )
#             x.df.to_excel(f'test_source_{i}_agg_{j}.xlsx')
#         except KeyError:
#             print('not possible')
#
