...
accis.addAccis(
    idfs=['TestModel_ExistingHVAC_PTAC.idf'],
    ScriptType='ex_mm',
...
run_energyplus(
    ...
    building_path='TestModel_ExistingHVAC_PTAC[CS_AUS DeDear[CA_80[CM_3[HM_2[VC_0[VO_0.0[MT_50.0[MW_50.0[AT_0.1[NS_X.idf',
    epw='Sydney.epw',
