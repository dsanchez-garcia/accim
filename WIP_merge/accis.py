    ...
    def __init__(
        ...
        for file in filelist:
            ...
            if 'vrf' in ScriptType.lower():
                ...
                z.addDetHVACobj(EnergyPlus_version=EnergyPlus_version, verboseMode=verboseMode, SupplyAirTempInputMethod=SupplyAirTempInputMethod, VRFschedule=VRFschedule)
