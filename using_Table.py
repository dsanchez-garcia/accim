...
# We can plot the figure with the following cell:

# In[16]:


dataset_hourly.line_plot_2(
    vars_to_gather_rows=['ComfMod', 'CAT'], # variables to gather in rows of subplots
    vars_to_gather_cols=['EPW_Scenario'],# variables to gather in columns of subplots
    detailed_rows=['CM_0[CA_3', 'CM_3[CA_3'], #we only want to see those combinations
    data_on_x_axis='EPW_City_or_subcountry', #column name (string) for the data on x axis
...
#     vars_to_keep=['EPW_City_or_subcountry', 'Month', 'Day', 'Hour'],
#     baseline='CM_0[CA_1',
