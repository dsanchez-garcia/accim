...
def test_addEMSProgramsBase(IDFobject):
    ...
    assert SetComfTemp[0].Program_Line_1 == 'if ComfStand == 1'
    assert SetComfTemp[0].Program_Line_2 == 'set ComfTemp = RMOT*0.33+18.8'
    assert SetComfTemp[0].Program_Line_3 == 'elseif ComfStand == 2'
    ...
    for zonename in zonenames:
        ...
        assert CountHours[0].Program_Line_1 == 'if (ComfStand == 1 )'
        ...
        assert CountHours[0].Program_Line_37 == 'elseif (ComfStand == 2 )'
    ...
    assert SetAppLimits[0].Program_Line_1 == 'If ComfStand == 1'
    ...
    assert SetAppLimits[0].Program_Line_6 == 'elseif ComfStand == 2'
    ...
    assert ApplyCAT[0].Program_Line_1 == 'if (ComfStand == 1 )'
    ...
    assert ApplyCAT[0].Program_Line_12 == 'elseif (ComfStand == 2 )'
    ...
    assert SetAST[0].Program_Line_14 == 'if (ComfStand == 1) && (ComfMod == 0)'
    ...
    assert SetAST[0].Program_Line_33 == 'if (ComfStand == 1) && (ComfMod == 0)'
    ...
    assert SetAST[0].Program_Line_52 == 'if (ComfStand == 1) && (ComfMod == 1) && (RMOT >= ACSTall) && (RMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_53 == 'set ACST = RMOT*0.33+18.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_54 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 7)'
    assert SetAST[0].Program_Line_55 == 'set ACST = 27+ACSTtol'
    assert SetAST[0].Program_Line_56 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 15)'
    assert SetAST[0].Program_Line_57 == 'set ACST = 50'
    assert SetAST[0].Program_Line_58 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 23)'
    assert SetAST[0].Program_Line_59 == 'set ACST = 25+ACSTtol'
    assert SetAST[0].Program_Line_60 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 24)'
    assert SetAST[0].Program_Line_61 == 'set ACST = 27+ACSTtol'
    assert SetAST[0].Program_Line_62 == 'endif'
    assert SetAST[0].Program_Line_63 == 'if (ComfStand == 1) && (ComfMod == 1) && (RMOT >= AHSTall) && (RMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_64 == 'set AHST = RMOT*0.33+18.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_65 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 7)'
    assert SetAST[0].Program_Line_66 == 'set AHST = 17+AHSTtol'
    assert SetAST[0].Program_Line_67 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 23)'
    assert SetAST[0].Program_Line_68 == 'set AHST = 20+AHSTtol'
    assert SetAST[0].Program_Line_69 == 'elseif (ComfStand == 1) && (ComfMod == 1) && (CurrentTime < 24)'
    assert SetAST[0].Program_Line_70 == 'set AHST = 17+AHSTtol'
    assert SetAST[0].Program_Line_71 == 'endif'
    assert SetAST[0].Program_Line_72 == 'if (ComfStand == 1) && (ComfMod == 2) && (RMOT >= ACSTall) && (RMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_73 == 'set ACST = RMOT*0.33+18.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_74 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < ACSTall) && (CAT==1)'
    assert SetAST[0].Program_Line_75 == 'set ACST = 25+ACSTtol'
    assert SetAST[0].Program_Line_76 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > ACSTaul) && (CAT==1)'
    assert SetAST[0].Program_Line_77 == 'set ACST = 25.5+ACSTtol'
    assert SetAST[0].Program_Line_78 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < ACSTall) && (CAT==2)'
    assert SetAST[0].Program_Line_79 == 'set ACST = 25+ACSTtol'
    assert SetAST[0].Program_Line_80 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > ACSTaul) && (CAT==2)'
    assert SetAST[0].Program_Line_81 == 'set ACST = 26+ACSTtol'
    assert SetAST[0].Program_Line_82 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < ACSTall) && (CAT==3)'
    assert SetAST[0].Program_Line_83 == 'set ACST = 25+ACSTtol'
    assert SetAST[0].Program_Line_84 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > ACSTaul) && (CAT==3)'
    assert SetAST[0].Program_Line_85 == 'set ACST = 27+ACSTtol'
    assert SetAST[0].Program_Line_86 == 'endif'
    assert SetAST[0].Program_Line_87 == 'if (ComfStand == 1) && (ComfMod == 2) && (RMOT >= AHSTall) && (RMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_88 == 'set AHST = RMOT*0.33+18.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_89 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < AHSTall) && (CAT==1)'
    assert SetAST[0].Program_Line_90 == 'set AHST = 21+AHSTtol'
    assert SetAST[0].Program_Line_91 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > AHSTaul) && (CAT==1)'
    assert SetAST[0].Program_Line_92 == 'set AHST = 23.5+AHSTtol'
    assert SetAST[0].Program_Line_93 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < AHSTall) && (CAT==2)'
    assert SetAST[0].Program_Line_94 == 'set AHST = 20+AHSTtol'
    assert SetAST[0].Program_Line_95 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > AHSTaul) && (CAT==2)'
    assert SetAST[0].Program_Line_96 == 'set AHST = 23+AHSTtol'
    assert SetAST[0].Program_Line_97 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT < AHSTall) && (CAT==3)'
    assert SetAST[0].Program_Line_98 == 'set AHST = 18+AHSTtol'
    assert SetAST[0].Program_Line_99 == 'elseif (ComfStand == 1) && (ComfMod == 2) && (RMOT > AHSTaul) && (CAT==3)'
    assert SetAST[0].Program_Line_100 == 'set AHST = 22+AHSTtol'
    assert SetAST[0].Program_Line_101 == 'endif'
    assert SetAST[0].Program_Line_102 == 'if (ComfStand == 1) && (ComfMod == 3) && (RMOT >= ACSTall) && (RMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_103 == 'set ACST = RMOT*0.33+18.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_104 == 'elseif (ComfStand == 1) && (ComfMod == 3) && (RMOT < ACSTall)'
    assert SetAST[0].Program_Line_105 == 'set ACST = ACSTall*0.33+18.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_106 == 'elseif (ComfStand == 1) && (ComfMod == 3) && (RMOT > ACSTaul)'
    assert SetAST[0].Program_Line_107 == 'set ACST = ACSTaul*0.33+18.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_108 == 'endif'
    assert SetAST[0].Program_Line_109 == 'if (ComfStand == 1) && (ComfMod == 3) && (RMOT >= AHSTall) && (RMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_110 == 'set AHST = RMOT*0.33+18.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_111 == 'elseif (ComfStand == 1) && (ComfMod == 3) && (RMOT < AHSTall)'
    assert SetAST[0].Program_Line_112 == 'set AHST = AHSTall*0.33+18.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_113 == 'elseif (ComfStand == 1) && (ComfMod == 3) && (RMOT > AHSTaul)'
    assert SetAST[0].Program_Line_114 == 'set AHST = AHSTaul*0.33+18.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_115 == 'endif'
    assert SetAST[0].Program_Line_116 == 'if (ComfStand == 2) && (ComfMod == 0)'
    ...
    assert SetAST[0].Program_Line_131 == 'if (ComfStand == 2) && (ComfMod == 0)'
    ...
    assert SetAST[0].Program_Line_146 == 'if (ComfStand == 2) && (ComfMod == 1) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_147 == 'set ACST = PMOT*0.31+17.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_148 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 7)'
    assert SetAST[0].Program_Line_149 == 'set ACST = 27+ACSTtol'
    assert SetAST[0].Program_Line_150 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 15)'
    assert SetAST[0].Program_Line_151 == 'set ACST = 50'
    assert SetAST[0].Program_Line_152 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 23)'
    assert SetAST[0].Program_Line_153 == 'set ACST = 25+ACSTtol'
    assert SetAST[0].Program_Line_154 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 24)'
    assert SetAST[0].Program_Line_155 == 'set ACST = 27+ACSTtol'
    assert SetAST[0].Program_Line_156 == 'endif'
    assert SetAST[0].Program_Line_157 == 'if (ComfStand == 2) && (ComfMod == 1) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_158 == 'set AHST = PMOT*0.31+17.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_159 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 7)'
    assert SetAST[0].Program_Line_160 == 'set AHST = 17+AHSTtol'
    assert SetAST[0].Program_Line_161 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 23)'
    assert SetAST[0].Program_Line_162 == 'set AHST = 20+AHSTtol'
    assert SetAST[0].Program_Line_163 == 'elseif (ComfStand == 2) && (ComfMod == 1) && (CurrentTime < 24)'
    assert SetAST[0].Program_Line_164 == 'set AHST = 17+AHSTtol'
    assert SetAST[0].Program_Line_165 == 'endif'
    assert SetAST[0].Program_Line_166 == 'if (ComfStand == 2) && (ComfMod == 2) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_167 == 'set ACST = PMOT*0.31+17.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_168 == 'elseif (ComfStand == 2) && (ComfMod == 2) && (PMOT < ACSTall)'
    assert SetAST[0].Program_Line_169 == 'set ACST = 23.9+ACSTtol'
    assert SetAST[0].Program_Line_170 == 'elseif (ComfStand == 2) && (ComfMod == 2) && (PMOT > ACSTaul)'
    assert SetAST[0].Program_Line_171 == 'set ACST = 26.8+ACSTtol'
    assert SetAST[0].Program_Line_172 == 'endif'
    assert SetAST[0].Program_Line_173 == 'if (ComfStand == 2) && (ComfMod == 2) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_174 == 'set AHST = PMOT*0.31+17.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_175 == 'elseif (ComfStand == 2) && (ComfMod == 2) && (PMOT < AHSTall)'
    assert SetAST[0].Program_Line_176 == 'set AHST = 19.6+AHSTtol'
    assert SetAST[0].Program_Line_177 == 'elseif (ComfStand == 2) && (ComfMod == 2) && (PMOT > AHSTaul)'
    assert SetAST[0].Program_Line_178 == 'set AHST = 23.6+AHSTtol'
    assert SetAST[0].Program_Line_179 == 'endif'
    assert SetAST[0].Program_Line_180 == 'if (ComfStand == 2) && (ComfMod == 3) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)'
    assert SetAST[0].Program_Line_181 == 'set ACST = PMOT*0.31+17.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_182 == 'elseif (ComfStand == 2) && (ComfMod == 3) && (PMOT < ACSTall)'
    assert SetAST[0].Program_Line_183 == 'set ACST = ACSTall*0.31+17.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_184 == 'elseif (ComfStand == 2) && (ComfMod == 3) && (PMOT > ACSTaul)'
    assert SetAST[0].Program_Line_185 == 'set ACST = ACSTaul*0.31+17.8+ACSToffset+ACSTtol'
    assert SetAST[0].Program_Line_186 == 'endif'
    assert SetAST[0].Program_Line_187 == 'if (ComfStand == 2) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)'
    assert SetAST[0].Program_Line_188 == 'set AHST = PMOT*0.31+17.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_189 == 'elseif (ComfStand == 2) && (ComfMod == 3) && (PMOT < AHSTall)'
    assert SetAST[0].Program_Line_190 == 'set AHST = AHSTall*0.31+17.8+AHSToffset+AHSTtol'
    assert SetAST[0].Program_Line_191 == 'elseif (ComfStand == 2) && (ComfMod == 3) && (PMOT > AHSTaul)'
