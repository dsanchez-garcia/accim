...
def test_addGlobVarListMultipleZone(IDFobject):
    ...
    assert gloVar[0].Erl_Variable_5_Name == 'ComfStand'
...
#     assert obj[0].Program_Line_2 == 'if ComfStand == 0'
...
#     assert obj[0].Program_Line_12 == 'elseif ComfStand == 1'
...
#     assert obj[0].Program_Line_18 == 'elseif ComfStand == 2'
