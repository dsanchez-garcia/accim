...
parameters = [
    Parameter(
        ...
        selector=GenericSelector(set=change_adaptive_coeff_all_zones(building=building)),
        # value_descriptor=CategoryParameter(options=adaptive_coeff_range)
    ),
    Parameter(
        # name='PMV',
        selector=GenericSelector(set=change_pmv_setpoint_all_zones(building=building)),
