...
#### 2.2.1.2 Longer version
    ...
    AddAccis(
        ...
        comfort_standard=list, # it is the Comfort Standard. Can be any integer from 0 to 22. For instance: comfort_standard=[0, 1, 2, 3],
...
> **Note (accim 1.0):** the API was renamed to snake_case in 1.0. If you are migrating
> from 0.7.x, see [MIGRATION.md](MIGRATION.md) for the full old→new name map.
