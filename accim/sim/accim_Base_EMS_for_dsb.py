...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_248='set ACSTx2 = ACST*SetpointAcc',
            Program_Line_249='set AHSTx2 = AHST*SetpointAcc',
            Program_Line_250='set roundedACSTx2 = @Round ACSTx2',
            Program_Line_251='set roundedAHSTx2 = @Round AHSTx2',
            Program_Line_252='if roundedACSTx2 - ACSTx2 < 0',
            Program_Line_253='set ACSTroundedUp = 0',
            Program_Line_254='else',
            Program_Line_255='set ACSTroundedUp = 1',
            Program_Line_256='endif',
            Program_Line_257='if roundedAHSTx2 - AHSTx2 < 0',
            Program_Line_258='set AHSTroundedUp = 0',
            Program_Line_259='else',
            Program_Line_260='set AHSTroundedUp = 1',
            Program_Line_261='endif',
            Program_Line_262='if ACSTroundedUp == 0',
            Program_Line_263='set roundedACST = roundedACSTx2 / SetpointAcc',
            Program_Line_264='else',
            Program_Line_265='set roundedACST = (roundedACSTx2 - 1) / SetpointAcc',
            Program_Line_266='endif',
            Program_Line_267='if AHSTroundedUp == 0',
            Program_Line_268='set roundedAHST = (roundedAHSTx2 + 1) / SetpointAcc',
            Program_Line_269='else',
            Program_Line_270='set roundedAHST = roundedAHSTx2 / SetpointAcc',
            Program_Line_271='endif',
        )
        if verboseMode:
