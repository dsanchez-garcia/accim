...
def inputdataSingleZone(self):
    ...
    self.ComfMod_List = list(int(num) for num in input("Enter the Comfort Mode numbers separated by space (0 = Static; 1 = OUT-CTE; 2 = OUT-SENXXXXX/SASHRAE55; 3 = OUT-AENXXXXX/AASHRAE55): ").split())
...
def inputdataMultipleZone(self):
    ...
    self.HVACmode_List = list(int(num) for num in input("Enter the HVACmode numbers separated by space (0 = Fully Air-conditioned; 1 = Naturally ventilated; 2 = MultipleZone): ").split())
