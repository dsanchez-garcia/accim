...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_195='set ACST = PMOT*0.48+14.4+ACSToffset+ACSTtol',
            ...
            Program_Line_202='set AHST = PMOT*0.48+14.4+AHSToffset+AHSTtol',
            ...
            Program_Line_209='set ACST = PMOT*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_210='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < ACSTall)',
            Program_Line_211='set ACST = ACSTall*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_212='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > ACSTaul)',
            Program_Line_213='set ACST = ACSTaul*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_214='endif',
            Program_Line_215='if (AdapStand == 3) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_216='set AHST = PMOT*0.48+14.4+AHSToffset+AHSTtol',
            Program_Line_217='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < AHSTall)',
            Program_Line_218='set AHST = AHSTall*0.48+14.4+AHSToffset+AHSTtol',
            Program_Line_219='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > AHSTaul)',
            Program_Line_220='set AHST = AHSTaul*0.48+14.4+AHSToffset+AHSTtol',
