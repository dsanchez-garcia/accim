...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_221='set ACST = PMOT*0.48+14.4+ACSToffset+ACSTtol',
            ...
            Program_Line_236='set AHST = PMOT*0.48+14.4+AHSToffset+AHSTtol',
            ...
            Program_Line_266='set AHST = PMOT*0.48+14.4+AHSToffset+AHSTtol',
            ...
            Program_Line_281='set ACST = PMOT*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_282='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < ACSTall)',
            Program_Line_283='set ACST = ACSTall*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_284='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > ACSTaul)',
            Program_Line_285='set ACST = ACSTaul*0.48+14.4+ACSToffset+ACSTtol',
            Program_Line_286='endif',
            Program_Line_287='if (AdapStand == 3) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_288='set AHST = PMOT*0.48+14.4+AHSToffset+AHSTtol',
            Program_Line_289='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < AHSTall)',
            Program_Line_290='set AHST = AHSTall*0.48+14.4+AHSToffset+AHSTtol',
            Program_Line_291='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > AHSTaul)',
            Program_Line_292='set AHST = AHSTaul*0.48+14.4+AHSToffset+AHSTtol',
