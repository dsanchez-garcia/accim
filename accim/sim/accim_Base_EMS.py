...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetComfTemp' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_40='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_46='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_52='if (DayOfYear <= 121) || (DayOfYear > 274)',
    ...
    if 'SetAppLimits' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_74='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_86='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_98='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_110='if (DayOfYear <= 121) || (DayOfYear > 274)',
    ...
    if 'ApplyCAT' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_95='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_103='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_113='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_121='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_131='if (DayOfYear <= 121) || (DayOfYear > 274)',
            ...
            Program_Line_139='if (DayOfYear <= 121) || (DayOfYear > 274)',
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_1399='if (ComfStand == 17) && (ComfMod == 3)',
            Program_Line_1400='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1401='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1402='set ACST = PMOT*0.48+13.9+ACSToffset+ACSTtol',
            Program_Line_1403='elseif PMOT < ACSTall',
            Program_Line_1404='set ACST = ACSTall*0.48+13.9+ACSToffset+ACSTtol',
            Program_Line_1405='elseif PMOT > ACSTaul',
            Program_Line_1406='set ACST = ACSTaul*0.48+13.9+ACSToffset+ACSTtol',
            Program_Line_1407='endif',
            Program_Line_1408='else',
            Program_Line_1409='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1410='set ACST = PMOT*0.59+9.6+ACSToffset+ACSTtol',
            Program_Line_1411='elseif PMOT < ACSTall',
            Program_Line_1412='set ACST = ACSTall*0.59+9.6+ACSToffset+ACSTtol',
            Program_Line_1413='elseif PMOT > ACSTaul',
            Program_Line_1414='set ACST = ACSTaul*0.59+9.6+ACSToffset+ACSTtol',
            Program_Line_1415='endif',
            Program_Line_1416='endif',
            Program_Line_1417='endif',
            Program_Line_1418='if (ComfStand == 17) && (ComfMod == 3)',
            Program_Line_1419='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1420='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1421='set AHST = PMOT*0.48+13.9+AHSToffset+AHSTtol',
            Program_Line_1422='elseif PMOT < AHSTall',
            Program_Line_1423='set AHST = AHSTall*0.48+13.9+AHSToffset+AHSTtol',
            Program_Line_1424='elseif PMOT > AHSTaul',
            Program_Line_1425='set AHST = AHSTaul*0.48+13.9+AHSToffset+AHSTtol',
            ...
            Program_Line_1430='elseif PMOT < AHSTall',
            Program_Line_1431='set AHST = AHSTall*0.59+9.6+AHSToffset+AHSTtol',
            Program_Line_1432='elseif PMOT > AHSTaul',
            Program_Line_1433='set AHST = AHSTaul*0.59+9.6+AHSToffset+AHSTtol',
            Program_Line_1434='endif',
            Program_Line_1435='endif',
            Program_Line_1436='endif',
            Program_Line_1437='if (ComfStand == 18) && (ComfMod == 3)',
            Program_Line_1438='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1439='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1440='set ACST = PMOT*0.84+5.3+ACSToffset+ACSTtol',
            Program_Line_1441='elseif PMOT < ACSTall',
            Program_Line_1442='set ACST = ACSTall*0.84+5.3+ACSToffset+ACSTtol',
            Program_Line_1443='elseif PMOT > ACSTaul',
            Program_Line_1444='set ACST = ACSTaul*0.84+5.3+ACSToffset+ACSTtol',
            Program_Line_1445='endif',
            Program_Line_1446='else',
            Program_Line_1447='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1448='set ACST = PMOT*0.96-3.6+ACSToffset+ACSTtol',
            Program_Line_1449='elseif PMOT < ACSTall',
            Program_Line_1450='set ACST = ACSTall*0.96-3.6+ACSToffset+ACSTtol',
            Program_Line_1451='elseif PMOT > ACSTaul',
            Program_Line_1452='set ACST = ACSTaul*0.96-3.6+ACSToffset+ACSTtol',
            Program_Line_1453='endif',
            Program_Line_1454='endif',
            Program_Line_1455='endif',
            Program_Line_1456='if (ComfStand == 18) && (ComfMod == 3)',
            Program_Line_1457='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1458='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1459='set AHST = PMOT*0.84+5.3+AHSToffset+AHSTtol',
            Program_Line_1460='elseif PMOT < AHSTall',
            Program_Line_1461='set AHST = AHSTall*0.84+5.3+AHSToffset+AHSTtol',
            Program_Line_1462='elseif PMOT > AHSTaul',
            Program_Line_1463='set AHST = AHSTaul*0.84+5.3+AHSToffset+AHSTtol',
            Program_Line_1464='endif',
            Program_Line_1465='else',
            Program_Line_1466='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1467='set AHST = PMOT*0.96-3.6+AHSToffset+AHSTtol',
            Program_Line_1468='elseif PMOT < AHSTall',
            Program_Line_1469='set AHST = AHSTall*0.96-3.6+AHSToffset+AHSTtol',
            Program_Line_1470='elseif PMOT > AHSTaul',
            Program_Line_1471='set AHST = AHSTaul*0.96-3.6+AHSToffset+AHSTtol',
            Program_Line_1472='endif',
            Program_Line_1473='endif',
            Program_Line_1474='endif',
            Program_Line_1475='if (ComfStand == 19) && (ComfMod == 3)',
            Program_Line_1476='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1477='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1478='set ACST = PMOT*0.27+17.9+ACSToffset+ACSTtol',
            Program_Line_1479='elseif PMOT < ACSTall',
            Program_Line_1480='set ACST = ACSTall*0.27+17.9+ACSToffset+ACSTtol',
            Program_Line_1481='elseif PMOT > ACSTaul',
            Program_Line_1482='set ACST = ACSTaul*0.27+17.9+ACSToffset+ACSTtol',
            Program_Line_1483='endif',
            Program_Line_1484='else',
            Program_Line_1485='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1486='set ACST = PMOT*0.53+10.3+ACSToffset+ACSTtol',
            Program_Line_1487='elseif PMOT < ACSTall',
            Program_Line_1488='set ACST = ACSTall*0.53+10.3+ACSToffset+ACSTtol',
            Program_Line_1489='elseif PMOT > ACSTaul',
            Program_Line_1490='set ACST = ACSTaul*0.53+10.3+ACSToffset+ACSTtol',
            Program_Line_1491='endif',
            Program_Line_1492='endif',
            Program_Line_1493='endif',
            Program_Line_1494='if (ComfStand == 19) && (ComfMod == 3)',
            Program_Line_1495='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1496='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1497='set AHST = PMOT*0.27+17.9+AHSToffset+AHSTtol',
            Program_Line_1498='elseif PMOT < AHSTall',
            Program_Line_1499='set AHST = AHSTall*0.27+17.9+AHSToffset+AHSTtol',
            Program_Line_1500='elseif PMOT > AHSTaul',
            Program_Line_1501='set AHST = AHSTaul*0.27+17.9+AHSToffset+AHSTtol',
            Program_Line_1502='endif',
            Program_Line_1503='else',
            Program_Line_1504='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1505='set AHST = PMOT*0.53+10.3+AHSToffset+AHSTtol',
            Program_Line_1506='elseif PMOT < AHSTall',
            Program_Line_1507='set AHST = AHSTall*0.53+10.3+AHSToffset+AHSTtol',
            Program_Line_1508='elseif PMOT > AHSTaul',
            Program_Line_1509='set AHST = AHSTaul*0.53+10.3+AHSToffset+AHSTtol',
            Program_Line_1510='endif',
            Program_Line_1511='endif',
            Program_Line_1512='endif',
            Program_Line_1513='if (ComfStand == 20) && (ComfMod == 3)',
            Program_Line_1514='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1515='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1516='set ACST = PMOT*0.38+15.7+ACSToffset+ACSTtol',
            Program_Line_1517='elseif PMOT < ACSTall',
            Program_Line_1518='set ACST = ACSTall*0.38+15.7+ACSToffset+ACSTtol',
            Program_Line_1519='elseif PMOT > ACSTaul',
            Program_Line_1520='set ACST = ACSTaul*0.38+15.7+ACSToffset+ACSTtol',
            Program_Line_1521='endif',
            Program_Line_1522='else',
            Program_Line_1523='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_1524='set ACST = PMOT*0.47+9.07+ACSToffset+ACSTtol',
            Program_Line_1525='elseif PMOT < ACSTall',
            Program_Line_1526='set ACST = ACSTall*0.47+9.07+ACSToffset+ACSTtol',
            Program_Line_1527='elseif PMOT > ACSTaul',
            Program_Line_1528='set ACST = ACSTaul*0.47+9.07+ACSToffset+ACSTtol',
            Program_Line_1529='endif',
            Program_Line_1530='endif',
            Program_Line_1531='endif',
            Program_Line_1532='if (ComfStand == 20) && (ComfMod == 3)',
            Program_Line_1533='if (DayOfYear <= 121) || (DayOfYear > 274)',
            Program_Line_1534='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1535='set AHST = PMOT*0.38+15.7+AHSToffset+AHSTtol',
            Program_Line_1536='elseif PMOT < AHSTall',
            Program_Line_1537='set AHST = AHSTall*0.38+15.7+AHSToffset+AHSTtol',
            Program_Line_1538='elseif PMOT > AHSTaul',
            Program_Line_1539='set AHST = AHSTaul*0.38+15.7+AHSToffset+AHSTtol',
            Program_Line_1540='endif',
            Program_Line_1541='else',
            Program_Line_1542='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_1543='set AHST = PMOT*0.47+9.07+AHSToffset+AHSTtol',
            Program_Line_1544='elseif PMOT < AHSTall',
            Program_Line_1545='set AHST = AHSTall*0.47+9.07+AHSToffset+AHSTtol',
            Program_Line_1546='elseif PMOT > AHSTaul',
            Program_Line_1547='set AHST = AHSTaul*0.47+9.07+AHSToffset+AHSTtol',
            Program_Line_1548='endif',
            Program_Line_1549='endif',
            Program_Line_1550='endif',
        )
        if verboseMode:
