...
def addEMSProgramsBase(self, ScriptType: str = None, verboseMode: bool = True):
    ...
    if 'SetComfTemp' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_7='elseif AdapStand == 4',
            Program_Line_8='set ComfTemp = 0',
            Program_Line_9='elseif AdapStand == 5',
            Program_Line_10='set ComfTemp = 0',
            Program_Line_11='elseif AdapStand == 6',
            Program_Line_12='set ComfTemp = PMOT*0.54+12.83',
            Program_Line_13='elseif AdapStand == 7',
            Program_Line_14='set ComfTemp = PMOT*0.28+17.87',
    ...
    if 'SetAppLimits' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_16='elseif (AdapStand == 4) || (AdapStand == 5)',
            ...
            Program_Line_33='elseif AdapStand == 6',
            Program_Line_34='set ACSTaul = 31',
            Program_Line_35='set ACSTall = 12.5',
            Program_Line_36='set AHSTaul = 31',
            Program_Line_37='set AHSTall = 12.5',
            Program_Line_38='elseif AdapStand == 7',
            Program_Line_39='set ACSTaul = 38.5',
            Program_Line_40='set ACSTall = 13',
            Program_Line_41='set AHSTaul = 38.5',
            Program_Line_42='set AHSTall = 13',
            Program_Line_43='else',
            Program_Line_44='set ACSTaul = 50',
            Program_Line_45='set ACSTall = 50',
            Program_Line_46='set AHSTaul = 50',
            Program_Line_47='set AHSTall = 50',
    ...
    if 'ApplyCAT' in programlist:
        ...
        self.idf1.newidfobject(
            ...
            Program_Line_20='elseif (AdapStand == 4 ) || (AdapStand == 5)',
            Program_Line_21='set ACSToffset = 0',
            Program_Line_22='set AHSToffset = 0',
            Program_Line_23='elseif (AdapStand == 6)',
            ...
            Program_Line_34='elseif (AdapStand == 7)',
    ...
    if 'SetAST' in programlist:
        ...
        self.idf1.newidfobject(
            'EnergyManagementSystem:Program',
            Name='SetAST',
            Program_Line_1='if (AdapStand == 0) && (CurrentTime < 8)',
            Program_Line_2='set ACST = 27+ACSTtol',
            Program_Line_3='set AHST = 17+AHSTtol',
            Program_Line_4='elseif (AdapStand == 0) && (CurrentTime < 16)',
            ...
            Program_Line_310='if (AdapStand == 4)',
            Program_Line_311='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_312='if CAT == 1',
            Program_Line_313='set ACST = PMOT*0.77+12.04+ACSTtol',
            Program_Line_314='set AHST = PMOT*0.87+2.76+AHSTtol',
            Program_Line_315='elseif CAT == 2',
            Program_Line_316='set ACST = PMOT*0.73+15.28+ACSTtol',
            Program_Line_317='set AHST = PMOT*0.91-0.48+AHSTtol',
            Program_Line_318='else',
            Program_Line_319='set ACST = 100',
            Program_Line_320='set AHST = -100',
            Program_Line_321='endif',
            Program_Line_322='endif',
            Program_Line_323='endif',
            Program_Line_324='if (AdapStand == 5)',
            Program_Line_325='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_326='if CAT == 1',
            Program_Line_327='set ACST = PMOT*0.77+9.34+ACSTtol',
            Program_Line_328='set AHST = PMOT*0.87-0.31+AHSTtol',
            Program_Line_329='elseif CAT == 2',
            Program_Line_330='set ACST = PMOT*0.73+12.72+ACSTtol',
            Program_Line_331='set AHST = PMOT*0.91-3.69+AHSTtol',
            Program_Line_332='else',
            Program_Line_333='set ACST = 100',
            Program_Line_334='set AHST = -100',
            Program_Line_335='endif',
            Program_Line_336='endif',
            Program_Line_337='endif',
            Program_Line_338='if (AdapStand == 6) && (ComfMod == 2)',
            Program_Line_339='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_340='set ACST = PMOT*0.54+12.83+ACSToffset+ACSTtol',
            Program_Line_341='elseif CAT==80',
            Program_Line_342='if PMOT < ACSTall',
            Program_Line_343='set ACST = 26.35+ACSTtol',
            Program_Line_344='elseif PMOT > ACSTaul',
            Program_Line_345='set ACST = 28.35+ACSTtol',
            Program_Line_346='endif',
            Program_Line_347='elseif CAT==85',
            Program_Line_348='if PMOT < ACSTall',
            Program_Line_349='set ACST = 25.72+ACSTtol',
            Program_Line_350='elseif PMOT > ACSTaul',
            Program_Line_351='set ACST = 27.89+ACSTtol',
            Program_Line_352='endif',
            Program_Line_353='elseif CAT==90',
            Program_Line_354='if PMOT < ACSTall',
            Program_Line_355='set ACST = 25.09+ACSTtol',
            Program_Line_356='elseif PMOT > ACSTaul',
            Program_Line_357='set ACST = 27.42+ACSTtol',
            Program_Line_358='endif',
            Program_Line_359='endif',
            Program_Line_360='endif',
            Program_Line_361='if (AdapStand == 6) && (ComfMod == 2)',
            Program_Line_362='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_363='set AHST = PMOT*0.54+12.83+AHSToffset+AHSTtol',
            Program_Line_364='elseif CAT==80',
            Program_Line_365='if PMOT < AHSTall',
            Program_Line_366='set AHST = 20.1+AHSTtol',
            Program_Line_367='elseif PMOT > AHSTaul',
            Program_Line_368='set AHST = 23.78+AHSTtol',
            Program_Line_369='endif',
            Program_Line_370='elseif CAT==85',
            Program_Line_371='if PMOT < AHSTall',
            Program_Line_372='set AHST = 20.77+AHSTtol',
            Program_Line_373='elseif PMOT > AHSTaul',
            Program_Line_374='set AHST = 24.26+AHSTtol',
            Program_Line_375='endif',
            Program_Line_376='elseif CAT==90',
            Program_Line_377='if PMOT < AHSTall',
            Program_Line_378='set AHST = 21.44+AHSTtol',
            Program_Line_379='elseif PMOT > AHSTaul',
            Program_Line_380='set AHST = 24.74+AHSTtol',
            Program_Line_381='endif',
            Program_Line_382='endif',
            Program_Line_383='endif',
            Program_Line_384='if (AdapStand == 6) && (ComfMod == 3) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_385='set ACST = PMOT*0.54+12.83+ACSToffset+ACSTtol',
            Program_Line_386='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < ACSTall)',
            Program_Line_387='set ACST = ACSTall*0.54+12.83+ACSToffset+ACSTtol',
            Program_Line_388='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > ACSTaul)',
            Program_Line_389='set ACST = ACSTaul*0.54+12.83+ACSToffset+ACSTtol',
            Program_Line_390='endif',
            Program_Line_391='if (AdapStand == 6) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_392='set AHST = PMOT*0.54+12.83+AHSToffset+AHSTtol',
            Program_Line_393='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < AHSTall)',
            Program_Line_394='set AHST = AHSTall*0.54+12.83+AHSToffset+AHSTtol',
            Program_Line_395='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > AHSTaul)',
            Program_Line_396='set AHST = AHSTaul*0.54+12.83+AHSToffset+AHSTtol',
            Program_Line_397='endif',
            Program_Line_398='if (AdapStand == 7) && (ComfMod == 2)',
            Program_Line_399='if (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_400='set ACST = PMOT*0.28+17.87+ACSToffset+ACSTtol',
            Program_Line_401='elseif CAT==80',
            Program_Line_402='if PMOT < ACSTall',
            Program_Line_403='set ACST = 26.35+ACSTtol',
            Program_Line_404='elseif PMOT > ACSTaul',
            Program_Line_405='set ACST = 28.35+ACSTtol',
            Program_Line_406='endif',
            Program_Line_407='elseif CAT==85',
            Program_Line_408='if PMOT < ACSTall',
            Program_Line_409='set ACST = 25.72+ACSTtol',
            Program_Line_410='elseif PMOT > ACSTaul',
            Program_Line_411='set ACST = 27.89+ACSTtol',
            Program_Line_412='endif',
            Program_Line_413='elseif CAT==90',
            Program_Line_414='if PMOT < ACSTall',
            Program_Line_415='set ACST = 25.09+ACSTtol',
            Program_Line_416='elseif PMOT > ACSTaul',
            Program_Line_417='set ACST = 27.42+ACSTtol',
            Program_Line_418='endif',
            Program_Line_419='endif',
            Program_Line_420='endif',
            Program_Line_421='if (AdapStand == 7) && (ComfMod == 2)',
            Program_Line_422='if (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_423='set AHST = PMOT*0.28+17.87+AHSToffset+AHSTtol',
            Program_Line_424='elseif CAT==80',
            Program_Line_425='if PMOT < AHSTall',
            Program_Line_426='set AHST = 20.1+AHSTtol',
            Program_Line_427='elseif PMOT > AHSTaul',
            Program_Line_428='set AHST = 23.78+AHSTtol',
            Program_Line_429='endif',
            Program_Line_430='elseif CAT==85',
            Program_Line_431='if PMOT < AHSTall',
            Program_Line_432='set AHST = 20.77+AHSTtol',
            Program_Line_433='elseif PMOT > AHSTaul',
            Program_Line_434='set AHST = 24.26+AHSTtol',
            Program_Line_435='endif',
            Program_Line_436='elseif CAT==90',
            Program_Line_437='if PMOT < AHSTall',
            Program_Line_438='set AHST = 21.44+AHSTtol',
            Program_Line_439='elseif PMOT > AHSTaul',
            Program_Line_440='set AHST = 24.74+AHSTtol',
            Program_Line_441='endif',
            Program_Line_442='endif',
            Program_Line_443='endif',
            Program_Line_444='if (AdapStand == 7) && (ComfMod == 3) && (PMOT >= ACSTall) && (PMOT <= ACSTaul)',
            Program_Line_445='set ACST = PMOT*0.28+17.87+ACSToffset+ACSTtol',
            Program_Line_446='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < ACSTall)',
            Program_Line_447='set ACST = ACSTall*0.28+17.87+ACSToffset+ACSTtol',
            Program_Line_448='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > ACSTaul)',
            Program_Line_449='set ACST = ACSTaul*0.28+17.87+ACSToffset+ACSTtol',
            Program_Line_450='endif',
            Program_Line_451='if (AdapStand == 7) && (ComfMod == 3) && (PMOT >= AHSTall) && (PMOT <= AHSTaul)',
            Program_Line_452='set AHST = PMOT*0.28+17.87+AHSToffset+AHSTtol',
            Program_Line_453='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT < AHSTall)',
            Program_Line_454='set AHST = AHSTall*0.28+17.87+AHSToffset+AHSTtol',
            Program_Line_455='elseif (AdapStand == 3) && (ComfMod == 3) && (PMOT > AHSTaul)',
            Program_Line_456='set AHST = AHSTaul*0.28+17.87+AHSToffset+AHSTtol',
            Program_Line_457='endif',
        )
        if verboseMode:
    ...
    if (ScriptType.lower() == 'vrf' or
        ...
        if 'SetVST' in programlist:
            ...
            self.idf1.newidfobject(
                ...
                Program_Line_18='elseif AdapStand == 2 || AdapStand == 3 || AdapStand == 6 || AdapStand == 7',
                ...
                Program_Line_23='endif',
                Program_Line_24='elseif AdapStand == 4 || AdapStand == 5',
                Program_Line_25='if (PMOT >= AHSTall) && (PMOT <= ACSTaul)',
                Program_Line_26='set VST = (ACST+AHST)/2+VSToffset',
                Program_Line_27='else',
                Program_Line_28='set VST = 0',
