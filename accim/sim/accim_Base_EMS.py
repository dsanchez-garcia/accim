        ...
        for zonename in self.zonenames:
            if 'ApplyAST_'+zonename in programlist:
                ...
                self.idf1.newidfobject(
                    ...
                    Program_Line_28='if (HVACmode == 2)',
                    Program_Line_29='if (VentCtrl == 0) || (VentCtrl==2)',
                    Program_Line_30='if ' + zonename + '_OpT>VST',
                    Program_Line_31='set Ventilates_HVACmode2_' + zonename + ' = 1',
                    Program_Line_32='else',
                    Program_Line_33='set Ventilates_HVACmode2_' + zonename + ' = 0',
                    Program_Line_34='endif',
                    Program_Line_35='elseif (VentCtrl==1) || (VentCtrl==3)',
                    Program_Line_36='if ' + zonename + '_OpT>AHST',
                    Program_Line_37='set Ventilates_HVACmode2_' + zonename + ' = 1',
                    Program_Line_38='else',
                    Program_Line_39='set Ventilates_HVACmode2_' + zonename + ' = 0',
                    Program_Line_40='endif',
                    Program_Line_41='else',
                    Program_Line_42='set Ventilates_HVACmode2_' + zonename + ' = 0',
                    Program_Line_43='endif',
                    Program_Line_44='else',
                    Program_Line_45='set Ventilates_HVACmode2_' + zonename + ' = 0',
                    Program_Line_46='endif',
                    Program_Line_47='else',
                    Program_Line_48='set Ventilates_HVACmode2_' + zonename + ' = 0',
                    Program_Line_49='endif',
                    Program_Line_50='if VentCtrl == 0',
                    Program_Line_51='if ' + zonename + '_OutT < ' + zonename + '_OpT',
                    Program_Line_52='if ' + zonename + '_OutT>MinOutTemp',
                    Program_Line_53='if ' + zonename + '_OpT > VST',
                    Program_Line_54='if ' + zonename + '_WindSpeed <= MaxWindSpeed',
                    Program_Line_55='set Ventilates_HVACmode1_' + zonename + ' = 1',
                    Program_Line_56='else',
                    Program_Line_57='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_58='endif',
                    Program_Line_59='else',
                    Program_Line_60='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_61='endif',
                    Program_Line_62='else',
                    Program_Line_63='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_64='endif',
                    Program_Line_65='else',
                    Program_Line_66='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_67='endif',
                    Program_Line_68='elseif VentCtrl == 1',
                    Program_Line_69='if ' + zonename + '_OutT<' + zonename + '_OpT',
                    Program_Line_70='if ' + zonename + '_OutT>MinOutTemp',
                    Program_Line_71='if ' + zonename + '_OpT > ACSTnoTol',
                    Program_Line_72='if ' + zonename + '_WindSpeed <= MaxWindSpeed',
                    Program_Line_73='set Ventilates_HVACmode1_' + zonename + ' = 1',
                    Program_Line_74='else',
                    Program_Line_75='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_76='endif',
                    Program_Line_77='else',
                    Program_Line_78='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_79='endif',
                    Program_Line_80='else',
                    Program_Line_81='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_82='endif',
                    Program_Line_83='else',
                    Program_Line_84='set Ventilates_HVACmode1_' + zonename + ' = 0',
                    Program_Line_85='endif',
                    Program_Line_86='endif',
                    Program_Line_87='if HVACmode == 0',
                    Program_Line_88='set ACST_Act_' + zonename + ' = ACST',
                    Program_Line_89='set AHST_Act_' + zonename + ' = AHST',
                    Program_Line_90='elseif HVACmode == 1',
                    Program_Line_91='Set ACST_Act_' + zonename + ' = 100',
                    Program_Line_92='Set AHST_Act_' + zonename + ' = -100',
                    Program_Line_93='if Ventilates_HVACmode1_' + zonename + ' == 1',
                    Program_Line_94='set VentHours_' + zonename + ' = 1',
                    Program_Line_95='else',
                    Program_Line_96='set VentHours_' + zonename + ' = 0',
                    Program_Line_97='endif',
                    Program_Line_98='elseif HVACmode == 2',
                    Program_Line_99='if Ventilates_HVACmode2_' + zonename + ' == 1',
                    Program_Line_100='set VentHours_' + zonename + ' = 1',
                    Program_Line_101='elseif Ventilates_HVACmode2_' + zonename + ' == 0',
                    Program_Line_102='set VentHours_' + zonename + ' = 0',
                    Program_Line_103='set ACST_Act_' + zonename + ' = ACST',
                    Program_Line_104='set AHST_Act_' + zonename + ' = AHST',
        ...
        for windowname in self.windownamelist:
            ...
            if 'SetWindowOperation_'+windowname in programlist:
                ...
                self.idf1.newidfobject(
                    ...
                    Program_Line_28='if (HVACmode == 2)',
                    Program_Line_29='if (VentCtrl == 0) || (VentCtrl==2)',
                    Program_Line_30='if ' + windowname + '_OpT>VST',
                    Program_Line_31='set Ventilates_HVACmode2_' + windowname + ' = 1',
                    Program_Line_32='else',
                    Program_Line_33='set Ventilates_HVACmode2_' + windowname + ' = 0',
                    Program_Line_34='endif',
                    Program_Line_35='elseif (VentCtrl==1) || (VentCtrl==3)',
                    Program_Line_36='if ' + windowname + '_OpT>AHST',
                    Program_Line_37='set Ventilates_HVACmode2_' + windowname + ' = 1',
                    Program_Line_38='else',
                    Program_Line_39='set Ventilates_HVACmode2_' + windowname + ' = 0',
                    Program_Line_40='endif',
                    Program_Line_41='else',
                    Program_Line_42='set Ventilates_HVACmode2_' + windowname + ' = 0',
                    Program_Line_43='endif',
                    Program_Line_44='else',
                    Program_Line_45='set Ventilates_HVACmode2_' + windowname + ' = 0',
                    Program_Line_46='endif',
                    Program_Line_47='else',
                    Program_Line_48='set Ventilates_HVACmode2_' + windowname + ' = 0',
                    Program_Line_49='endif',
                    Program_Line_50='if VentCtrl == 0',
                    Program_Line_51='if ' + windowname + '_OutT < ' + windowname + '_OpT',
                    Program_Line_52='if ' + windowname + '_OutT>MinOutTemp',
                    Program_Line_53='if ' + windowname + '_OpT > VST',
                    Program_Line_54='if ' + windowname + '_WindSpeed <= MaxWindSpeed',
                    Program_Line_55='set Ventilates_HVACmode1_' + windowname + ' = 1',
                    Program_Line_56='else',
                    Program_Line_57='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_58='endif',
                    Program_Line_59='else',
                    Program_Line_60='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_61='endif',
                    Program_Line_62='else',
                    Program_Line_63='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_64='endif',
                    Program_Line_65='else',
                    Program_Line_66='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_67='endif',
                    Program_Line_68='elseif VentCtrl == 1',
                    Program_Line_69='if ' + windowname + '_OutT<' + windowname + '_OpT',
                    Program_Line_70='if ' + windowname + '_OutT>MinOutTemp',
                    Program_Line_71='if ' + windowname + '_OpT > ACSTnoTol',
                    Program_Line_72='if ' + windowname + '_WindSpeed <= MaxWindSpeed',
                    Program_Line_73='set Ventilates_HVACmode1_' + windowname + ' = 1',
                    Program_Line_74='else',
                    Program_Line_75='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_76='endif',
                    Program_Line_77='else',
                    Program_Line_78='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_79='endif',
                    Program_Line_80='else',
                    Program_Line_81='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_82='endif',
                    Program_Line_83='else',
                    Program_Line_84='set Ventilates_HVACmode1_' + windowname + ' = 0',
                    Program_Line_85='endif',
                    Program_Line_86='endif',
                    Program_Line_87='if HVACmode == 0',
                    Program_Line_88='set ' + windowname + '_VentOpenFact = 0',
                    Program_Line_89='elseif HVACmode == 1',
                    Program_Line_90='if Ventilates_HVACmode1_' + windowname + ' == 1',
                    Program_Line_91='set ' + windowname + '_VentOpenFact = ' + windowname + '_MyVOF',
                    Program_Line_92='else',
                    Program_Line_93='set ' + windowname + '_VentOpenFact = 0',
                    Program_Line_94='endif',
                    Program_Line_95='elseif HVACmode == 2',
                    Program_Line_96='if Ventilates_HVACmode2_' + windowname + ' == 1',
                    Program_Line_97='if (VentCtrl==0) || (VentCtrl==1)',
                    Program_Line_98='set ' + windowname + '_VentOpenFact = 1',
                    Program_Line_99='elseif (VentCtrl==2) || (VentCtrl==3)',
                    Program_Line_100='set ' + windowname + '_VentOpenFact = ' + windowname + '_MyVOF',
                    Program_Line_101='endif',
                    Program_Line_102='else',
                    Program_Line_103='set ' + windowname + '_VentOpenFact = 0',
                    Program_Line_104='endif',
                    Program_Line_105='endif',
                )
                if verboseMode:
