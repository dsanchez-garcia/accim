...
"Adaptive Cooling Setpoint Temperature_No Tolerance;Adaptive Heating Setpoint Temperature_No Tolerance;Zone Operative Temperature;AFN Zone Infiltration Air Change Rate;AFN Zone Ventilation Air Change Rate"

"Adaptive Cooling Setpoint Temperature_No Tolerance;Adaptive Heating Setpoint Temperature_No Tolerance;Zone Operative Temperature;AFN Zone Infiltration Air Change Rate;AFN Zone Ventilation Air Change Rate;Ventilation Hours_PLANTAX08_OFFICE"
...
# full_factorial = {
#     'CustAST_m': [round(i, 2) for i in np.arange(0, 0.8, 0.1)],
#     'CustAST_n': [round(i, 2) for i in np.arange(5, 25, 2.5)]
# }
...
evaluator = EvaluatorEP(
    ...
    building=building,
    epw='Sydney.epw',
    out_dir=f'test param original'
)

outputs = evaluator.df_apply(
    parameters_values_df_part_test,
    keep_input=True,
    keep_dirs=True,
    # out_dir='outdir',
    processes=6
