class Table:
    ...
    def generate_fig_data(self,
        ...
        for i in range(len(self.rows)):
            ...
            for j in range(len(self.cols)):
                if baseline is not None and len(adap_vs_stat_data_y_main) > 0:
                    ...
                    temp_col = []
                    for k in range(len(self.y_main_units)):
                        temp = {
                            'axis': [i, j],
                            ...
                            'dataframe': [
                                ...
                                for dataset in self.y_main_units[k][1]
                            ],
                            'label': [dataset for dataset in data_on_y_main_axis],
                            'color': [color for color in colorlist_y_main_axis]
                        }
        ...
        for i in range(len(self.rows)):
            ...
            for j in range(len(self.cols)):
                temp_col = []
                for k in range(len(self.y_sec_units)):
                    ...
                    temp = {
                        ...
                        'dataframe': [
                            self.df_for_graph[[x for x in self.df_for_graph.columns if self.rows[i] in x and self.cols[j] in x and dataset in x]]
                            for dataset in self.y_sec_units[k][1]
                            ],
                        'label':[dataset for dataset in data_on_y_sec_axis],
                        'color': [color for color in colorlist_y_sec_axis]
                    }
                    temp_col.append(temp)
                temp_row.append(temp_col)
